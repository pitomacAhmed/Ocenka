...
public class Ocenka {
	...
	System.out.println("Vnesete go brojot na osvoeni bodovi");
	...
	if(procent<51) {
		...
		System.out.println("Studentod dobil 6");
	}
	else if (procent<=70 && procent>=61) {
		System.out.println("Studentod dobil 7");
	}
	else if (procent<=80 && procent>=71) {
		System.out.println("Studentod dobil 8");
	}
	else if (procent<=90 && procent>=81) {
		System.out.println("Studentod dobil 9");
    }
	else if (procent<=100 && procent>=91) {
		System.out.println("Studentod dobil 10");
		}
	 }
	}
